...
from src.models.mass.mtom_iteration import mtom_iteration_loop
...
class PyMTOMImplicit(om.ImplicitComponent):
    ...
    def setup(self):
        ...
        # Newton solver for the scalar implicit solve
    ...
    def linearize(self, inputs, outputs, partials):
        # linearization of the MTOM residual R = full_mtom_model(m, params, ...) - m
        params = self.options['parameters']
        import jax
