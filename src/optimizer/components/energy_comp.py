...
from src.models.energy.energy_trip import energy_reserve
...
class EnergyComp(om.ExplicitComponent):
    ...
    def compute_partials(self, inputs, partials):
        ...
        out_names = ['E_total_req', 'E_trip', 'E_hover', 'E_climb', 'E_cruise', 'E_reserve', 't_cruise', 't_trip']
        ...
        def fun(x):
            ...
            return jnp.array([E_total_req, E_trip, E_hover, E_climb, E_cruise, E_reserve, t_cruise, t_trip])
